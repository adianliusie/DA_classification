...
class LEDDecoderPatched(LEDPreTrainedModel):
    ...
    def forward(
        ...
        # embed positions
        #LINE REMOVED      positions = self.embed_positions(input_shape, past_key_values_length)  
        positions = pos_encoding # added line 3
...
class LEDModelPatched(LEDPreTrainedModel):
    ...
    def forward(
        ...
        #here i get the specific positional encodings related to [CLS] and [SEP]
        output = []
